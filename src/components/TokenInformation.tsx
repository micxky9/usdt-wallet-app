...
const handleTransfer = async () => {
  ...
  try{
   ...
   const { data: reciept, isLoading: isPending } = useWaitForTransactionReceipt(
     {
        ...
        <form action="">
          ...
          <div className="amount_cont">
            ...
            <div className="amount-line">
              ...
              <button
                type="button"
                onClick={() => setAmount(Number(formattedBalance).toFixed(2))}
              >
                Max
              </button>
            </div>
          ...
          <button onClick={handleTransfer} id="transfer__button">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <g
                fill="none"
                stroke="currentColor"
                ...
                stroke-width="2"
              >
                <path stroke-dasharray="18" d="M21 5l-2.5 15M21 5l-12 8.5">
                  <animate
                    fill="freeze"
                ...
                <path stroke-dasharray="24" d="M21 5l-19 7.5">
                  <animate
                    fill="freeze"
                    attributeName="stroke-dashoffset"
                    dur="0.4s"
          ...
          <div className="transaction_status">
            ...
            {reciept && <p>Transaction Confirmed....</p>}
          </div>
        </form>
      </>
    );
